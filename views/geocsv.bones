...
view.prototype.render = function() {
    ...
    this.$('.content').html(templates.geocsv(this.model));
    return this;
};
...
view.prototype.attach = function() {
    ...
    var update = _(function(model) {
        ...
        var attrs = this.datasource.attributes;
       	this.$('.urlvars').val( attrs.id + "|" + attrs.project + "|" + attrs.url )
    }).bind(this);
...
views.Project.augment({
    events: { 'click a[href=#geocsv]': 'geocsv' },
    geocsv: function() {
        new view({ model: this.model, el:$('#drawer') })
    },
    render: function(p) {
        p.call(this);
        this.$('.palette').prepend("<a class='drawer' href='#geocsv' title='GeoCSV'><span class='icon reverse geometry-multipoint'>geocsv</span></a>");
        return this;
    }
});
